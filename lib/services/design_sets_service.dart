...
/// ~60 цветов в 8 группах + 5 материалов.
class DesignSetsService {
  /// Цвета сгруппированы по группам.
  /// group-идентификаторы используются для вкладок в пикере.
  ...
  /// 5 материалов с эффектами (без изменений)
  ...
  /// Описание групп для пикера (id → название + иконка)
  static const List<ColorGroup> groups = [
